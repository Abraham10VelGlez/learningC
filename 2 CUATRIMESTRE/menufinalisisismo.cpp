...
int programa328()
{
	/*16) Un censador recopila ciertos datos aplicando encuestas para el último censo
...
main()
{
	...
	while(opcm<0 || opcm>3)
	{
		...
		printf("\n\n\ntultimo avance de programacion.");
		printf("\n\nSeleccione el avance de programa.");
		printf("\n\n\ Avance 1. \n\n\ Avance 2. \n\n\ Avance 3. \n\n ");
		printf("\n\n\t\t\\t\t\tjhonatan jacobo garcia villavicencio.");
		...
		if(opcm==1)
		{
			...
			printf("\t\ejercicios del primer avance .");
		...
		if (opcm==2)
		{
			...
			printf("\t\tejercicios nuemro 2.");
			printf("\n\nSeleccione el programa que decea analaizar.");
			printf("\n\ Programa 1. \n Programa 2. \n Programa 3.\n Programa 4.\n Programa 5.\n Programa 6.\n Programa 7.\n Programa 8.\n Programa 9.\n Programa 10. ");
			printf("\n\nusted eligio la opcion: ");
			scanf("%d",&opcp);
				printf("jhonatan garcia v");
				if(opcp==1)
				{
					system("cls");
					printf("\t\tPROGRAMA 1 .\n\n");
